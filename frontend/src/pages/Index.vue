  ...
  <div class="container col-md-7 col-sm-12 sm-container">
    ...
    <div v-if="!loaded" class="row mt-5 mb-5">
      <div class="col-12 mt-5 mb-2 text-center">
        <FontAwesomeIcon icon="circle-notch" class="text-dim" size="2x" spin/>
      </div>
    ...
    <div class="col-12 full-col-12 d-flex flex-row-reverse">
      <div class="mb-2">
        <button class="btn btn-sm btn-outline-primary" @click.prevent="previousServicePage">
          <font-awesome-icon icon="backward"/>
        </button>
        <button class="btn btn-sm btn-outline-primary" @click.prevent="nextServicePage">
